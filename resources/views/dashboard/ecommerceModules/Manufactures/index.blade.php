                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a href="{{ aurl('Manufactures/create') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i>
                                    {{ __('admin.addManufactures') }}</a>
                            </li>
                        </ul>
                                    ...
                                    @foreach ($data as $key => $value)
                                        ...
                                        <tr class="{{ $pointer }}">
                                            ...
                                            <td class=" last">
                                                ...
                                                <a href="{{ aurl('Manufactures/' . $value->slug . '/edit') }}"
                                        ...
                                        <div class="modal fade bs-example-modal-lg{{ $value->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ aurl('Manufactures/' . $value->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')

                                                        <div class="modal-body">
                                                            <h4>{{ trans('admin.deleteCon') }}</h4>
                                                            <p>{{ trans('admin.deleteMessageModal') .' :  '. $value->name }}</p>
                                                        </div>
