                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a href="{{ aurl('Categories/create') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i>
                        ...
                        <div class="table-responsive">
                            ...
                            <input type="checkbox" id="check-all" class="flat">
                                        ...
                                        @foreach (languages() as $language)
                                            ...
                                            <th class="column-title">{{ __('admin.category_description_' . $language) }}
                                            </th>
                                        @endforeach
                                    ...
                                    @foreach ($data as $key => $value)
                                        ...
                                        <tr class="{{ $pointer }}">
                                            ...
                                            @foreach ($value->description as $k => $desc)
                                                ...
                                                <td class=" ">{!! strip_tags($desc->description) !!} </td>
                                            @endforeach
                                            ...
                                            <td class=" last">
                                                ...
                                                <a href="{{ aurl('Categories/' . $value->slug . '/edit') }}"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myModalLabel">{{__('admin.removeRaw')}}</h4>
                                                        <button type="button" class="close"
                                                            data-dismiss="modal"><span aria-hidden="true">×</span>
                                                        </button>
                                                    </div>

                                                    <form action="{{ aurl('Categories/' . $value->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
