        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a href="{{ aurl('Products/Attributes/create') }}"
                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    ...
                    <tr class="{{ $pointer }}">
                      ...
                      @foreach (languages() as $language)
                        <td class=" ">
                          {{ $value->description->firstWhere('language', $language)->name }}
                        </td>
                      @endforeach
                      <th>
                        <a href="{{ aurl('Products/Attributes/' . $value->id . '/Options') }}"
                    ...
                    <div class="modal fade bs-example-modal-lg{{ $value->id }}"
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="{{ aurl('Products/Attributes/' . $value->id) }}"
                            method="post">
                            @csrf
                            @method('delete')
