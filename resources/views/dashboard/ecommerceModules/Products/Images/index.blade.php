        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a href="{{ aurl('Products/Images/create') }}"
                  class="btn btn-primary"><i class="fa fa-plus"></i>
                  {{ __('admin.addProductImages') }}</a>
              </li>
            </ul>
            <div class="clearfix"></div>
          </div>
              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    ...
                    <tr class="{{ $pointer }}">
                      <td class=" ">{{ ++$key }}</td>
                      <td class="column-title"><img src="{{ asset('storage/'.$value->path) }}"
                          width="100"></td>
                    ...
                    <div class="modal fade bs-example-modal-lg{{ $value->id }}"
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="{{ aurl('Products/Images/' . $value->id) }}"
                            method="post">
                            @csrf
                            @method('delete')
