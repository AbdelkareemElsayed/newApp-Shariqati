        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a href="{{ aurl('Products/ManageAttributeOptions/create') }}"
              ...
              <table class="table table-striped jambo_table bulk_action">
                <thead>
                  <tr class="headings">
                    ...
                    @endforeach
                    <th class="column-title">{{ __('admin.optionPrice') }}</th>
                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    ...
                    <tr class="{{ $pointer }}">
                      ...
                      @foreach (languages() as $language)
                        <td class=" ">
                          {{ $value->details->value->firstWhere('language', $language)->name }}
                        </td>
                      @endforeach
                      <th>
                        {{ $value->price }}
                    ...
                    <div class="modal fade bs-example-modal-lg{{ $value->id }}"
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="{{ aurl('Products/ManageAttributeOptions/' . $value->id) }}"
                            method="post">
                            @csrf
                            @method('delete')
