        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a href="{{ aurl('SubItemsLevel/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                  {{ __('admin.subBusinessItems') }}</a>
              </li>
            </ul>
                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    ...
                    <tr class="{{ $pointer }}">
                      ...
                      <td>
                        <a href="{{ aurl('BusinessItemsFlashsale/' . $value->id  ) }}"
                    ...
                    <div class="modal fade bs-example-modal-lg{{ $value->id }}" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="{{ aurl('SubItemsLevel/' . $value->id) }}" method="post">
                            @csrf
                            @method('delete')
