      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form action="{{ url('admin/Blogs/Categories') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                @foreach (languages() as $language)
                  <div class="field item form-group">
                    <label class="col-form-label col-md-3 col-sm-3  label-align" for="name_en">Name
                  ...
                  <div class="field item form-group">
                    <label class="col-form-label col-md-3 col-sm-3  label-align" for="description_en">Descreiption
                      {{ $language }}<span class="required">*</span></label>
                    <div class="col-md-6 col-sm-6">
                      <textarea class="form-control desc_{{ $language }}" name="description_{{ $language }}"
