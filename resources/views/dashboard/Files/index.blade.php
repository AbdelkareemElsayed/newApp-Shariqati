                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a href="{{ aurl('AccountFiles/create') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i>
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            ...
                            <input type="checkbox" id="check-all" class="flat">
                                        ...
                                        <th class="column-title">{{ trans('admin.AddedBy') }} </th>
                                        <th class="column-title">{{ trans('admin.show') }} </th>
                                ...
                                <tbody>
                                    @foreach ($data as $key => $value)
                                        ...
                                        <tr class="{{ $pointer }}">
                                            <td class=" ">{{ ++$key }}</td>
                                            <td class=" ">{{ $value->uploadedBy->name }} </td>
                                            <td> <a href="{{ asset('storage/Files/' . $value->name) }}"
                                                    class="btn btn-primary">{{ trans('admin.OPen') }}</a> </a>
                                            </td>
                                        ...
                                        <div class="modal fade bs-example-modal-lg{{ $value->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ aurl('AccountFiles/' . $value->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
