        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a href="{{ aurl('Slider/create') }}" class="btn btn-primary"> <i
                    class="fa fa-plus"></i>{{ __('admin.addSlide') }}</a>
              </li>
              {{-- <li class="dropdown">
              ...
              <table class="table table-striped jambo_table bulk_action">
                <thead>
                  <tr class="headings">
                    ...
                    <th class="column-title">Alt Text</th>
