            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{ aurl('Address') }}" method="post" novalidate enctype="multipart/form-data">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" name="fulladdress"  value="{{old('fulladdress')}}" placeholder="{{trans('admin.addressHint')}}" required="required" />
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input  type="url"  class="form-control" name="location"  value="{{old('location')}}" placeholder="{{trans('admin.LocationHint')}}" required="required" />
                                    </div>
                                </div>

                              
                                 <input type="hidden" name="country_id" value="{{$data->GetCustomerCountry->id}}">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select class="form-control state_id" required name="state_id">
                                            <option>Choose option</option>
                                            @foreach ($data->GetCustomerCountry->States as $state )
