      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <form action="{{ aurl('Languages') }}" method="post" enctype="multipart/form-data" novalidate>
                @csrf
                ...
                <div class="field item form-group">
                  ...
                  <div class="col-md-6 col-sm-6">
                    <input class="form-control" name="name" placeholder="English" value="{{ old('name') }}" />
                  </div>
                </div>
                ...
                <div class="field item form-group">
                  <label class="col-form-label col-md-3 col-sm-3  label-align" for="code">{{ __('admin.code') }}<span
                      class="required">*</span></label>
                  <div class="col-md-6 col-sm-6">
                    <input class="form-control" name="code" placeholder="en" value="{{ old('code') }}" />
                  </div>
                </div>
