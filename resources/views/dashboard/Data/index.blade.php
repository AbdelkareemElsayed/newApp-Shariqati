        ...
        <div class="x_panel">
          <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
              <li><a href="{{ aurl('Data/create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                  {{ __('admin.addFolder') }}</a>
              </li>
              {{-- <li class="dropdown">
              ...
              <table class="table table-striped jambo_table bulk_action">
                <thead>
                  <tr class="headings">
                    ...
                    <th class="column-title">{{ __('admin.listFiles ') }}</th>
                ...
                <tbody>
                  @foreach ($data as $key => $value)
                    ...
                    <tr class="{{ $pointer }}">
                      ...
                      <td class=" "><a href="{{ aurl('Files/' . $value->id) }}"
                          class="btn btn-primary">{{ __('admin.listFiles') }}</a>
                      </td>
                      <td class=" last">
                        <a data-toggle="modal" data-target=".bs-example-modal-lg{{ $value->id }}"
                          class="btn btn-danger">{{ trans('admin.delete') }}</a>
                        <a href="{{ aurl('Data/' . $value->id . '/edit') }}"
                    ...
                    <div class="modal fade bs-example-modal-lg{{ $value->id }}" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="{{ aurl('Data/' . $value->id) }}" method="post">
                            @csrf
                            @method('delete')
